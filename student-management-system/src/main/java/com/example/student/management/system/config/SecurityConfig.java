...
import com.example.student.management.system.Service.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .formLogin(form -> form
                        .loginPage("/login")
                        .loginProcessingUrl("/login")  // Ensure Spring Security handles the login request
